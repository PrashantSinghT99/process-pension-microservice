...
import com.pms.cde.processPensionMicroservice.model.CustomErrorResponse;
...
class ProcessPensionMicroserviceApplicationTests {
	...
	void testAllArgsCustomErrorResponse() {
		CustomErrorResponse cr = new CustomErrorResponse(LocalDateTime.of(2019, 03, 28, 14, 33, 48, 123456789),
				HttpStatus.NOT_FOUND, "Not found", Arrays.asList("Bad request"));
	...
	void testSetterPensionerDetail() {
		...
		pensionerDetail.setName("Prem");
		pensionerDetail.setPan("ABCDU1236L");
	...
	void testPensionerDetailCompareTo() {
		...
		bank.setBankName("SBI");
		bank.setBankType("public");
		PensionerDetail pensionerDetail1 = new PensionerDetail("Prem", new Date(1999, 12, 10), "ITHYU1236L",
				100000.0, 45000.0, "family", bank);
		PensionerDetail pensionerDetail2 = new PensionerDetail("Prem", new Date(1999, 12, 10), "ITHYU1236L",
				100000.0, 45000.0, "family", bank);
		PensionerDetail pensionerDetail3 = new PensionerDetail("Srikanth", new Date(1999, 12, 10), "ITHYU1236L", 100000.0,
				45000.0, "family", bank);
	...
	void testSetterPensionerInput() {
		...
		pensionerInput.setName("Prem");
		pensionerInput.setDateOfBirth(new Date(1999, 12, 10));
		pensionerInput.setPan("ABCDU1236L");
